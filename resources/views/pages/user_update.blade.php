...
<div class="card">
    <div class="card-header">
        <h4 class="mt-2">Update Data User</h4>
    </div>

    <div class="card-body p-5">
        <form class="row g-3" method="POST" action="{{ route('user.update', ['id' => $users->id]) }}">
            @csrf
            ...
            <div class="col-md-6">
                ...
                <input id="email" type="email" class="form-control" name="email" value="{{ old('email', $users->email) }}" required autocomplete="email">
            </div>
            ...
            <div class="col-md-10">
                ...
                <input id="address" type="text" class="form-control" name="address" value="{{ old('address', $users->address) }}" required autocomplete="address">
            </div>
